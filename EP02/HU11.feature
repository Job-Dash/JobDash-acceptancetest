...
Scenario: E01: Ingreso a mi perfil para cambiar mi foto
        ...
        Examples:
            | Sección actualizar datos | Boton subir imagen | Resultado                                       |
            | Gleider Castro           | clic()             | La nueva imagen se muestra en su perfil         |
        TA02:
        ...
        Examples:
            | Sección actualizar datos | Boton subir imagen | Resultado                                                           |
            | Gleider Castro           | clic()             | mensaje="La imagen seleccionada supera el tamaño permitido"         |
        TA03:
        ...
        Examples:
            | Sección actualizar datos | Boton subir imagen | Resultado                                   |
            | Gleider Castro           | clic()             | mensaje="La cuenta esta en actualización"   |