Feature: Como trabajador con experiencia no registrado en la aplicación, deseo crearme una cuenta, para poder acceder a las características de la app.d
    Scenario: E01: Registro exitoso
        CA01

        Given se encuentra en el formulario de registro de cuenta para trabajadores profesionales
    ...
    Scenario: E02: Registro inválido
        ...
        Given se encuentra en el formulario de registro de cuenta para trabajadores con experiencia
