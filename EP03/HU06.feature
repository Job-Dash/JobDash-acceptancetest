Feature: Como usuario no registrada en la aplicación, deseo crearme una cuenta, para poder acceder a las características de la app.
    Scenario: E01: Registro exitoso
        CA01

        Given se encuentra en el formulario de registro de cuenta para usuarios
        When ingresa un DNI inexistente, su correo electrónico no existe (no registrado), y una contraseña válida (mayor o igual a 8 caracteres que incluyan al menos una letra y un número) junto a la confirmación de contraseña (la misma contraseña escrita correctamente).
        ...
        Examples:
            ...
            | 721812922     | clic()                       | Registro exitoso , siga los pasos enviados a su correo |
    ...
    Scenario: E02: Registro inválido
        ...
        Examples:
            ...
            | saaaborxd@gmail.com | clic()                       | correo electrónico ya está registrado |
    ...
    Scenario: E03: Subir documentos importantes
        ...
        Then la app muestra un mensaje diciéndo que el DNI ya está registrado, y sugiere iniciar sesión.

        Examples:
            | DNI            | Boton opcion “Registrarse”   | mensaje                    |
            | 72181292       | clic()                       | el DNI ya está registrado  |

    Scenario: E04: 
        CA04

        Given está en el formulario de registro de cuenta para usuarios
    ...
    Scenario: E05: 
        ...
        And presiona el botón “Registrarse”
        Then la aplicación muestra un mensaje de error del DNI.

        Examples:
            | DNI            | Boton opcion “Registrarse”   | mensaje                         |
            | 72181292       | clic()                       | el DNI ingresado es inexistente |

    Scenario: E06: 
        CA06

        Given está en el formulario de registro de cuenta para usuarios
        When ingresa un correo electrónico que no está asociado a su DNI, pero los demás datos son correctos
        And presiona el botón “Registrarse”
        Then la aplicación muestra un mensaje de error de comprobación del DNI

        Examples:
            | correo-electronico   | Boton opcion “Registrarse” | mensaje                                          |
            | andynzein@gmail.com  | clic()                     | correo electrónico que no está asociado a su DNI |
